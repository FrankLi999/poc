...
import algo.functional.OneArgumentExpression;
import algo.functional.ThreeArgumentStatement;
import algo.functional.TwoArgumentStatement;
import algo.graph.Graph.CostEdge;
import algo.structure.LinkedHeap;
import algo.structure.LinkedList;
import algo.structure.OrderedStore;
import algo.structure.PriorityQueue;
import algo.structure.QueueImplLinkedList;
import algo.structure.StackImplLinkedList;
...
public interface Graph<V, E> {
    ...
    default void checkDirectedCycleFromVertex(
            algo.functional.LinkedList<Integer> path, BinarySearchTree<Integer> allVertices){
        int top = path.head();
        allVertices.deleteValue(top);
        LinkedList<Integer> neighbors = getNeighbors(top);
        for(int n:neighbors){
            algo.functional.LinkedList<Integer> pathPart = path;
