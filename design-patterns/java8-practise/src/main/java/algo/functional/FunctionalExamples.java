...
public class FunctionalExamples {
    public static void main(String[] args)
        ...
        // t.start();
        // t.join();
        algo.functional.LinkedList<Integer> linkedList =
        		algo.functional.LinkedList.<Integer>emptyList().add(5).add(3).add(0);
...
//
        algo.functional.LinkedList<Integer> linkedList2 =
        		algo.functional.LinkedList.<Integer>emptyList().add(6).add(8).add(9);
//        linkedList.append(linkedList2).forEach(System.out::println);

        algo.functional.LinkedList.ofRange(1, 10)
                .flatMap((x) -> algo.functional.LinkedList.ofRange(0, x))
...
//                .forEach(System.out::println);
    ...
    public static BigInteger factorial(int x) {
        return algo.functional.LinkedList.ofRange(1, x + 1)
    ...
    public static String repeatString(final String seed, int count) {
        return algo.functional.LinkedList.ofRange(1, count + 1)
                .map((a) -> seed)
                .foldLeft("", (a, b) -> a + b);
    }
