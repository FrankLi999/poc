package com.bpwizard.boot.oauth1.woocommerce.oauth;

import org.apache.commons.codec.binary.Base64;

import com.bpwizard.boot.oauth1.woocommerce.HttpMethod;
...
public class OAuthSignature {
    ...
    private static String signBaseString(String secret, String signatureBaseString) {
        System.out.println(">>>>>>>>>>>>>>>>>>>> signed secret: " + secret);
        System.out.println(">>>>>>>>>>>>>>>>>>>> signed signatureBaseStrin: " +
            signatureBaseString);
        Mac macInstance;
        try {
            ...
            String signed = Base64.encodeBase64String(macInstance.doFinal(signatureBaseString.getBytes(UTF_8)));
