...
java -Xdebug -Xrunjdwp:server=y,transport=dt_socket,address=8000,suspend=n -jar target/my-authorization-server-jwt.jar

Resource Server:
java -Xdebug -Xrunjdwp:server=y,transport=dt_socket,address=9000,suspend=n -jar target/my-resource-server-jwt.jar
mvn spring-boot:run -Dspring-boot.run.jvmArguments="-Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=9000"
