  ...
  providers: {
    ...
    okta: {
      ...
      authorizationEndpoint:
        'https://dev-907835.oktapreview.com/oauth2/v1/authorize',
      redirectUri: getRedirectUri(),
      requiredUrlParams: ['scope'],
      optionalUrlParams: ['display'],
    ...
    keycloak: {
      ...
      url: '/auth/keycloak',
      authorizationEndpoint:
        'http://localhost:8180/auth/realms/SpringBootKeycloak/protocol/openid-connect/auth',
      redirectUri: getRedirectUri(),
      requiredUrlParams: ['scope'],
      optionalUrlParams: ['display'],
      scope: ['openid', 'profile', 'email'],
