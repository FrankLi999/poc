...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public KeyManager keyManager() {
        ...
        Resource storeFile = loader.getResource("classpath:/saml/keycloak_keystore.jks");
        //String storePass = "nalle123";
        String storePass = "Passw0rd";
        Map<String, String> passwords = new HashMap<String, String>();
        //passwords.put("apollo", "nalle123");
        //String defaultKey = "apollo";
        passwords.put("saml-test", "Passw0rd");
        String defaultKey = "saml-test";
    ...
    public Protocol socketFactoryProtocol() {
        return new Protocol("https", socketFactory(), 18443);
    }
    ...
    public ExtendedMetadata extendedMetadata() {
    	...
    	extendedMetadata.setIdpDiscoveryEnabled(false);//true); 
	...
	public ExtendedMetadataDelegate keycloakExtendedMetadataProvider()
		...
		String idpKeycloakMetadataURL = "https://keycloak.bpwizard.com:18443/auth/realms/demo/protocol/saml/descriptor";
		HTTPMetadataProvider httpMetadataProvider = new HTTPMetadataProvider(
				this.backgroundTaskTimer, httpClient(), idpKeycloakMetadataURL);
		httpMetadataProvider.setParserPool(parserPool());
		ExtendedMetadataDelegate extendedMetadataDelegate = 
				new ExtendedMetadataDelegate(httpMetadataProvider, extendedMetadata());
		extendedMetadataDelegate.setMetadataTrustCheck(false);//true);
