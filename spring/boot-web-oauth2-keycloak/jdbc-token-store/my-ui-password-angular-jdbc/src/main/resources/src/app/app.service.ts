...
export class AppService {
  ...
  obtainAccessToken(loginData){
    ...
    params.append('client_id','curl_client');

    let headers = new Headers({'Content-type': 'application/x-www-form-urlencoded; charset=utf-8', 'Authorization': 'Basic '+btoa("curl_client:user")});
