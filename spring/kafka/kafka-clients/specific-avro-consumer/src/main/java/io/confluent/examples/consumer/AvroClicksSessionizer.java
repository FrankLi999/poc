...
public class AvroClicksSessionizer {
    ...
    public static void main(String[] args) {
        ...
        sessionizer = new AvroClicksSessionizer(bootstrapServer, groupId, inputTopic, outputTopic, url, sessionLengthMs);
        sessionizer.run();
    }

    public AvroClicksSessionizer(String bootstrapServer, String groupId, String inputTopic, String outputTopic, String url, int sessionLengthMs) {
        this.consumer = kafka.consumer.Consumer.createJavaConsumerConnector(
                new ConsumerConfig(createConsumerConfig(bootstrapServer, groupId, url)));
    ...
    private Properties createConsumerConfig(String bootstrapServer, String groupId, String url) {
    ...
    private void run() {
        ...
        Properties props = createConsumerConfig(bootstrapServer, groupId, url);
