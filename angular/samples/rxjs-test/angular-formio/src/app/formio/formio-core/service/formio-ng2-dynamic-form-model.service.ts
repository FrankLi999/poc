...
@Injectable()
export class FormioNg2DynamicFormModelService {

    constructor(private formBuilder: FormBuilder, private validationService: FormioNg2DynamicFormValidationService) {}
    ...
    createForm(appModel: any): FormGroup {
      return null;
    }
    ...
    findControlModelById(id: string, appModel: any): FormioFormControlModel | null {
      return null;
    }
