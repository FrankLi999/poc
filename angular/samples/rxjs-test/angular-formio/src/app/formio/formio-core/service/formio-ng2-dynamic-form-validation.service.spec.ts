...
describe("FormioNg2DynamicFormValidationService test suite", () => {

    let service: FormioNg2DynamicFormValidationService;
    ...
    beforeEach(inject([FormioFormValidationService],
        (validationService: FormioFormValidationService) => service = validationService));
    ...
    it("should create error messages correctly", () => {
        ...
        let errorMessages,
            ...
            testModel: FormioFormControlModel = new FormioInputModel({
                id: "testModel",
                errorMessages: {
