...
} from "./formio-radio-group.model";

describe("FormioRadioModel test suite", () => {

    let model: FormioRadioGroupModel<string>,
        config = {
            id: "radio",
    ...
    beforeEach(() => model = new FormioRadioGroupModel(config));
    ...
    it("should initialize correctly", () => {
        ...
        expect(model.type).toEqual(FORMIO_FORM_CONTROL_TYPE_RADIO_GROUP);
    ...
    it("should serialize correctly", () => {
        ...
        expect(json.type).toEqual(FORMIO_FORM_CONTROL_TYPE_RADIO_GROUP);
    });
});