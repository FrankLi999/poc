...
@Component({
  selector: 'formio-material-slide-toggle',
  templateUrl: './formio-material-slide-toggle.component.html'
})
export class FormioMaterialSlideToggleComponent extends FormioMaterialFormControlComponent  {
