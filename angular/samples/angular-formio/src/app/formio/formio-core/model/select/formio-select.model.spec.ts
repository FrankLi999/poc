...
import {
  ...
  FormioSelectModel
} from "./formio-select.model";

describe("FormioSelectModel test suite", () => {

    let model: FormioSelectModel<string>,
        config = {
            id: "select",
            multiple: false,
            options: [
    ...
    beforeEach(() => model = new FormioSelectModel(config));
    ...
    it("should initialize correctly", () => {
        ...
        expect(model.type).toEqual(FORMIO_FORM_CONTROL_TYPE_SELECT);
    ...
    it("should serialize correctly", () => {
        ...
        expect(json.type).toEqual(FORMIO_FORM_CONTROL_TYPE_SELECT);
    });
});