...
@Component({
  selector: "binary-upload",
  templateUrl: "./binary-upload.component.html",
  styleUrls: ["./binary-upload.component.scss"],
})
export class BinaryUploadComponent implements OnInit {
  form: FormGroup;
  ...
  SERVER_URL: string = "http://localhost:8080/upload/binary";
