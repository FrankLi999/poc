...
var DynamicUIBasicSelectComponent = (function (_super) {
    __extends(DynamicUIBasicSelectComponent, _super);
    function DynamicUIBasicSelectComponent(changeDetectorRef, validationService) {
        var _this = _super.call(this, changeDetectorRef, validationService) || this;
        _this.changeDetectorRef = changeDetectorRef;
        _this.validationService = validationService;
        return _this;
    }
    return DynamicUIBasicSelectComponent;
}(dynamic_ui_basic_form_control_component_1.DynamicUIBasicFormControlComponent));
DynamicUIBasicSelectComponent = __decorate([
    core_1.Component({
...
exports.DynamicUIBasicSelectComponent = DynamicUIBasicSelectComponent;
var _a;

//# sourceMappingURL=dynamic-ui-basic-select.component.js.map
