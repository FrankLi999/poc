...
import com.beosbank.jbdevg.jbdatagrid.listener.InifispanClientListener;
...
public class RemoteCacheDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println(ConfigurationProperties.DEFAULT_HOTROD_PORT);
		// Connect to the server
		RemoteCacheManager cacheManager = new RemoteCacheManager(builder.build());
		// Obtain the remote cache
		RemoteCache<String, Object> cache = cacheManager.getCache();
		cache.addClientListener(new InifispanClientListener());
