...
public class FluentLogger {
    ...
    public boolean log(String tag, Map<String, Object> data, long timestamp) {
        System.out.println("============>>>>>>>>>>> fluent logger sender class:" + this.sender);
    ...
    public void flush() {
        System.out.println("============>>>>>>>>>>> fluent loggrt flush");
        sender.flush();
    }

    public void close() {
        System.out.println("============>>>>>>>>>>> fluent loggrt close");
        if (sender != null) {
            sender.flush();
            sender.close();
            sender = null;
    ...
    public void finalize() {
        System.out.println("============>>>>>>>>>>> fluent loggrt finalize");
        if (sender != null) {
            sender.close();
        }
    }
