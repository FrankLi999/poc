...
export function registerComponent (Vue, name, def) {
  Vue._dynamic_ui_vue_components_ = Vue._dynamic_ui_vue_components_ || {}
  const loaded = Vue._dynamic_ui_vue_components_[name]
  if (!loaded && def && name) {
    Vue._dynamic_ui_vue_components_[name] = true
...
export function registerDirective (Vue, name, def) {
  Vue._dynamic_ui_vue_directives_ = Vue._dynamic_ui_vue_directives_ || {}
  const loaded = Vue._dynamic_ui_vue_directives_[name]
  if (!loaded && def && name) {
    Vue._dynamic_ui_vue_directives_[name] = true
